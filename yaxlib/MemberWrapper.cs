...
namespace YAXLib
{
    ...
    internal class MemberWrapper
    {
        ...
        private bool m_isAttributedAsNotCollection = false;
        ...
        public MemberWrapper(MemberInfo memberInfo, YAXSerializer callerSerializer, UdtWrapper a_udt)
        {
            ...
            foreach (var attr in m_memberInfo.GetCustomAttributes(false))
            {
                if (attr is YAXBaseAttribute)
                    ProcessYAXAttribute(attr, callerSerializer, a_udt);
            }
        }
        ...
        public bool CDATA { get; private set; }
        ...
        public object DefaultValue
        {
            ...
            private set
            {
                ...
                // Fight with mixing i.e. double with int, int with byte and so on...
                if (m_defaultValue != null)
                    if (m_defaultValue.GetType() != MemberType)
        ...
        /// </value>
        public bool IsAttributedAsNotCollection
        {
            get
            {
                if (m_memberTypeWrapper.IsOuterCollection)
                    m_isAttributedAsNotCollection = false;
                return m_isAttributedAsNotCollection;
            }
            private set
            {
                m_isAttributedAsNotCollection = value;
            }
        }
        ...
        public bool OmitWhenDefault { get; private set; }
        ...
        public bool IsOuterCollection
        {
            get
            {
                return m_memberTypeWrapper.IsOuterCollection;
            }
        }

        public bool IsInnerCollection
        {
            get
            {
                if (CollectionAttributeInstance == null)
                    return false;
                return CollectionAttributeInstance.SerializationType ==
        ...
        public bool IsAllowedToBeSerialized(YAXSerializationFields serializationFields)
        {
            ...
            {
                return !this.IsAttributedAsDontSerialize &&
                    (this.IsAttributedAsSerializable || this.IsSerializedAsValue ||
                    this.IsSerializedAsAttribute ||
                    (this.CollectionAttributeInstance != null) ||
                    (this.CustomDeserializerType != null) ||
                    (this.CustomSerializerType != null));
            }
        ...
        private void ProcessYAXAttribute(object attr, YAXSerializer callerSerializer, UdtWrapper a_udt)
        {
            ...
            else if (attr is YAXNodeAttribute)
            {
                var temp = attr as YAXNodeAttribute;
                this.IsAttributedAsSerializable = true;
                if (temp.Alias != null)
                    this.Alias = temp.Alias;
                this.CDATA = temp.CDATA;

                if (!Object.ReferenceEquals(temp.Default, YAXNodeAttribute.DefaultValueNotSet))
                {
                    this.DefaultValue = temp.Default;
                    this.TreatErrorsAs = YAXExceptionTypes.Ignore;
                    this.OmitWhenDefault = temp.OmitWhenDefault;
                }
                else if (this.OmitWhenDefault)
            ...
            {
                this.IsAttributedAsSerializable = true;
                this.Alias = (attr as YAXSerializeAsAttribute).Alias;
            }
            ...
            else if (attr is YAXCollectionAttribute)
            {
                ...
                if (m_collectionAttributeInstance.Name != null)
                    this.Alias = m_collectionAttributeInstance.Name;

                if (m_collectionAttributeInstance.SerializationType ==
                    YAXCollectionSerializationTypes.InnerCollectionRecursiveInElement)
                {
                    a_udt.IsAttributedAsNotCollection = true;
                }
            }
            ...
            else if (attr is YAXSerializeAttribute)
            {
