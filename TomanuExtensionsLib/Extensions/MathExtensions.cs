...
namespace TomanuExtensions
{
    public static class MathExtensions
    {
        ...
        public static double Sqr(double a_x)
        {
            return a_x * a_x;
        }

        public static float Sqr(float a_x)
        {
            return a_x * a_x;
        }

        public static int Sqr(int a_x)
        {
            return a_x * a_x;
        }

        public static uint Sqr(uint a_x)
        {
            return a_x * a_x;
        }

        public static long Sqr(long a_x)
        {
            return a_x * a_x;
        }

        public static ulong Sqr(ulong a_x)
        {
            return a_x * a_x;
        }
    }
