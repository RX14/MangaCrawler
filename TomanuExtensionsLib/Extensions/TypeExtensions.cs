...
namespace TomanuExtensions
{
    ...
    public static class TypeExtensions
    {
        ...
        public static object InvokeMember(this Type a_type, string a_name, BindingFlags a_invoke_attr, Binder a_binder,
            object a_target, params object[] a_args)
        {
            return a_type.InvokeMember(a_name, a_invoke_attr, a_binder, a_target, a_args);
        }
    }
}