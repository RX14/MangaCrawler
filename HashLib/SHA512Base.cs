...
namespace HashLib
{
    internal abstract class SHA512Base : HashCryptoNotBuildIn
    {
        #region Consts
        ...
        {
            ulong lowBits = m_processedBytes << 3;
            ulong hiBits = m_processedBytes >> 61;
            ...
            pad[padindex++] = (byte)(hiBits >> 56);
            pad[padindex++] = (byte)(hiBits >> 48);
            pad[padindex++] = (byte)(hiBits >> 40);
            pad[padindex++] = (byte)(hiBits >> 32);
            pad[padindex++] = (byte)(hiBits >> 24);
            pad[padindex++] = (byte)(hiBits >> 16);
            pad[padindex++] = (byte)(hiBits >> 8);
            pad[padindex++] = (byte)hiBits;

            pad[padindex++] = (byte)(lowBits >> 56);
            pad[padindex++] = (byte)(lowBits >> 48);
            pad[padindex++] = (byte)(lowBits >> 40);
            pad[padindex++] = (byte)(lowBits >> 32);
            pad[padindex++] = (byte)(lowBits >> 24);
            pad[padindex++] = (byte)(lowBits >> 16);
            pad[padindex++] = (byte)(lowBits >> 8);
            pad[padindex++] = (byte)lowBits;
        ...
        protected override void TransformBlock(byte[] a_data, int a_index)
        {
            ...
            for (int ti = 16; ti <= 79; ++ti)
            {
                ...
                data[ti] = (((T1 << 45) | (T1 >> 19)) ^ ((T1 << 3) | (T1 >> 61)) ^ (T1 >> 6)) + data[ti - 7] + 
                              (((T0 << 63) | (T0 >> 1)) ^ ((T0 << 56)| (T0 >> 8)) ^ (T0 >> 7)) + data[ti - 16];
            }
